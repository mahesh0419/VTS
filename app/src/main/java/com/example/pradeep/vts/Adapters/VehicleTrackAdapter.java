 ...
 */
public class VehicleTrackAdapter extends BaseAdapter {

    ArrayList<HashMap<String,String>> vehicleData;
    Context context;
    LayoutInflater inflater;
    public VehicleTrackAdapter(Context context,ArrayList<HashMap<String,String>> vehicleData)
    {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView==null)
        {
            ...
            convertView=inflater.inflate(R.layout.for_row_vehicle_track,parent,false);
